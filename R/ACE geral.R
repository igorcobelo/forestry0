...
#Grafico de distribuicao diametrica por estrato
  ...
  #Encontrar quantas parcelas há em cada estrato
  for(i in 1:max(x[,1])){
  ...
  if(prop==F){
    ...
    #alocação ótima dos estratos
    nj<-(((P*s)/sum(P*s))*n)
  }

  if(prop==T){
    #P/ ALOCAÇÃO PROPORCIONAL
    ...
    #alocação proporcional dos estratos
...
if(pt==T){
  ...
  if(sum(ss)>=n){
    if(pt==T){
    cat("\n------------------------------------------------------------------------------------\n")
    cat("A intensidade amostral satisfaz o erro requerido de", E*100,"%, para um nível de significância de",p*100,"%.")
    cat("\n Portanto, não é necessário amostrar mais parcelas.\n")
    cat("------------------------------------------------------------------------------------")
    }else{
      cat("\n------------------------------------------------------------------------------------\n")
  ...
  if(sum(ss)<n){
    if(pt==T){
    cat("\n------------------------------------------------------------------------------------\n")
    cat("A intensidade amostral não satisfaz o erro requerido de", E*100,"%, para um nível de significância de",p*100,"%.")
    cat("\n Portanto, é necessário amostrar mais",ceiling(n-sum(ss)),"parcelas.\n")
    cat("------------------------------------------------------------------------------------")
    }else{
      cat("\n------------------------------------------------------------------------------------\n")
  ...
  if(anova$`F value`[1]>ftab){
    ...
    cat("------------------------------------------------------------------------------------")
    cat("\nHá diferença significativa entre as médias dos estratos.\n")
    cat("------------------------------------------------------------------------------------")
    }else{
      cat("------------------------------------------------------------------------------------")
  ...
  if(anova$`F value`[1]<ftab){
    ...
    if(pt==T){
    cat("------------------------------------------------------------------------------------")
    cat("\nNão há diferença significativa entre as médias dos estratos.\n")
    cat("------------------------------------------------------------------------------------")
    }else{
      cat("------------------------------------------------------------------------------------")
